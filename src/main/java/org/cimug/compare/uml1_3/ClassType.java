...
@XmlType(name = "ClassType", propOrder = { "content" })
public class ClassType implements ContentsContainer, PackagedElement, NamedType, GUIDIdentifier {
	...
	public ClassType(List<Serializable> content, String xmiId, String visibility, String isRoot, String isLeaf,
	...
	public String toString() {
		String str = "Class [name = " + name + ", xmiId = " + xmiId + ", parentPackageName = " + getParentPackageName()
				+ "]";
