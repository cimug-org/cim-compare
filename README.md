...
**cim-compare** has two possible command-line usages to produce comparison reports. Option #2 is typically the preferred option as it does not require the extra steps required to generate a comparison log file from within Enterprise Architect ([see: EA_COMPARISON_PROCEDURES.md](https://github.com/CIMug-org/cim-compare/blob/gh-pages/EA_COMPARISON_PROCEDURES.md)).
